...
import { dataService, Memorial, FuneralHome } from "@/services/dataService";
import { 
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-gray-100">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-teal-100 flex items-center justify-center">
              <span className="text-teal-700 font-semibold text-sm">PE</span>
            </div>
            <div className="flex-1 min-w-0">
              <p className="font-medium text-gray-900 text-sm truncate">{funeralHome?.name}</p>
      ...
      <main className="md:ml-64 p-4 sm:p-6 md:p-8 pt-16 md:pt-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="card-modern p-6">
            ...
            <p className="text-3xl font-bold text-gray-900">{stats.totalDedications}</p>
                ...
                >
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-500">{memorial.birthDate} - {memorial.deathDate}</p>
                    </div>
                  </div>
